    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cell_type', models.CharField(choices=[('c', 'Consumer'), ('p', 'Producer')], default='c', max_length=1)),
            ],
            options={
                'ordering': ['-created'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cell', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='location', to='cells.cell')),
            ],
        ),
        migrations.AddField(
            model_name='cell',
        ...
        migrations.AddField(
            model_name='cell',
            name='producer_cell',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='consumer_cells', to='cells.cell'),
        ),
        migrations.CreateModel(
